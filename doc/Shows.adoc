...
All of these things could be done before the Show interface, using
basic Triggers, but they would involve writing a great many custom
Expressions to match the tracks and watch for the right beats, and
would be very tedious to figure out.
