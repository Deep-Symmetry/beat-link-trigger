...
code the phrase, track and player status, and your code can use any
...
The phrase trigger is divided into, whose sizes you get to choose
using the
<<Shows_PhraseTriggers.adoc#enabling-weighting,*Start*, *Loop*, *End*,
and *Fill* Spinners>>. The size you choose will determine the size of
the portion of canvas on which you can place cues for each section of
the phrase trigger:
