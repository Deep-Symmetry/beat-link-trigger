...
NOTE: This page is a draft, describing the new phrase triggers
feature as it is in the process of being implemented.
...
image:PTCuesEditor.png[Phrase Trigger Cues Editor window,898,726]
