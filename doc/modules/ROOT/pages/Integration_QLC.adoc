...
xref:attachment$/QLC-Cues.bls[integration show], then <<Shows.adoc#opening-shows,open>> and use it as described next, and ignore the rest of the explanation of how it works until you are curious about that.
