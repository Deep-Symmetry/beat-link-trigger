...
The approach is described and explained in detail below, or you can start by downloading the corresponding link:{attachmentsdir}/grandMA2.blt[configuration file] and loading that within Beat Link Trigger.
