...
https://web.archive.org/web/20211204155543/https://lxhues.com/[Alex
Hughes] inquired if it would be possible to use a trigger to
synchronize a speed master for effects on a
...
automatically when the right parts of the right tracks are played. But
honestly, learn about Shows, they are so much easier to set up, and do
