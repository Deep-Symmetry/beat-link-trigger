...
image:CarabinerConnectionMenu.png[Ableton Link: Carabiner Connection menu,365,184]
...
image:RealPlayerNumber.png[Using a Real Player Number,365,184]
====
...
Expression>>, and there is an example of how to do this in the
