...
image:PlaylistWriter.png[Playlist Writer,460,313]
...
You can also configure how many minutes can pass with no player
playing anything before a new playlist file is created when another
track is played. The default for this is 30 minutes. When creating new
...
image:PlaylistWriterActive.png[Playlist Writer active,460,313]
