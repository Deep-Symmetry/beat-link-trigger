...
The easiest way to have timestamps appear in your video is to download and <<Shows.adoc#opening-shows,open>> the xref:attachment$/Timestamp.bls[Timestamp show] that is embedded in this guide, and position its window near the part of your screen where you are capturing the issue.
