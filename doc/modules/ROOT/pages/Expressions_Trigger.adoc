...
It now https://resolume.com/support/en/link[supports Ableton Link], and <<Link.adoc#,so does BLT>>, so you can use that for easier, even more stable synchronization.

And please see Inneffable's https://www.youtube.com/watch?v=wVkOyBQV798[great video] for a full tutorial on the modern approach to synchronizing videos in Resolume with tracks in BLT.
====
