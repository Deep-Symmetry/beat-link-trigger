...
(The OSC path was found by Editing the OSC Applicaton Map within Arena and clicking on the parameter I wanted to control, as described in the https://resolume.com/training/2/13/76[online training].)
