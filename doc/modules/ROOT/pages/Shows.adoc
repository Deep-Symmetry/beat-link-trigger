...
filter (explained <<Shows_Tracks.adoc#enabled-menu,below>>), and to
filter which Tracks are currently visible, which is helpful when you
...
the <<Expressions.adoc#show-global-expressions,Expressions section>>.
