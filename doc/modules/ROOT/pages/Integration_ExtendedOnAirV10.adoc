...
An https://deep-symmetry.zulipchat.com/#narrow/stream/275322-beat-link-trigger/topic/Question.20about.20Mixer.20Data[interesting question] from https://www.twitch.tv/drfrankenspine[DrFrankenspine] in the project Zulip discussion community led to some cool developments.
