...
> And, even though it doesn't use Beat Link Trigger, I'd like to call
  your attention to a really cool
  https://cardinia.net/products/pro/[hardware project] that will
  likely be of interest to the same people who like BLT. It allows you
  to use the Touch Preview and Link Cue audio features of the newer
  Pioneer players with any mixer.
