...
Clint's written a guide to getting started with the Orange Pi project in the wiki section.  You can check it out here: https://github.com/Deep-Symmetry/beat-link-trigger/wiki/Guide:-Building-the-Orange-Pi-LTC-SMPTE-Timecode-Reader,-Converter-&-Generator
