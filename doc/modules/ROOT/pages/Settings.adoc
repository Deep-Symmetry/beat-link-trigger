...
You can also use the older monochrome blue waveforms (this was previously possible using a Global Setup expression, but it is now exposed in the Settings window).
