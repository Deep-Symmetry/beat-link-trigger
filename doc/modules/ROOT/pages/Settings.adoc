...
If you want to automatically start xref:Debugging.adoc#writing-playlists[writing to a playlist file] as soon as you go online, you first need to choose a folder where they can be written, using the **Choose** button.
