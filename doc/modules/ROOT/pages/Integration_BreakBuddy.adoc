...
advantage of the <<Shows_CueLibrary#,Cue Library>> feature of Beat
...
See the <<Shows_CueLibrary.adoc#,Cue Library guide>> if you need a
reminder of how to place such cues in a show track. This section
describes how three of them are used to perform a smooth,
tempo-adjusted mix between _Concrete Angel_ and _Transcendence_ in
this sample show.
