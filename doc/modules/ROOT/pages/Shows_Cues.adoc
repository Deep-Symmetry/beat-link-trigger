...
You can also interact with cues in this window. Hovering the mouse
pointer over a cue displays information about it. Clicking on one with
your mouse will scroll its configuration row into view in the lower
section of the window if it was not already visible. Dragging an edge
left or right will adjust the beat on which the cue begins or ends.
Right-clicking or control-clicking a cue brings up the
<<cue-context-menu,cue context menu>> which gives you many other
options, and clicking on a cue with the kbd:[Option] or kbd:[Alt] key
held down is a quick way to <<cue-simulate,simulate>> its Started
On-Beat and Ended events.
...
when Beat Link Trigger is Online (or you are
<<SimulatingPlayback.adoc#,simulating playback>>), because they only
make sense in the context of being able to detect that a player has
loaded the track.
...
As a shortcut for testing your Entered Message configuration, clicking
on the *Message* label with the kbd:[Option] or kbd:[Alt] key held
down is a quick way to <<cue-simulate,simulate>> the Entered and
Exited events.
...
TIP: As a shortcut for testing your Started On-Beat Message
configuration, clicking on the *On-Beat Message* label with the
kbd:[Option] or kbd:[Alt] key held down is a quick way to
<<cue-simulate,simulate>> the Started On-Beat and corresponding Ended
events.
...
TIP: As a shortcut for testing your Started Late Message
configuration, clicking on the *Late Message* label with the
kbd:[Option] or kbd:[Alt] key held down is a quick way to
<<cue-simulate,simulate>> the Started Late and corresponding Ended
events.
...
moments to customize the behavior of the Cue. If you have created any
expressions for the cue, the menu:View Expressions in Report[] option
will be present at the top of the menu. Selecting it tells your system
browser to open the <<Expressions_Report.adoc#>> and scroll it to the
section that holds this cue’s expressions.

The expression-related options are followed by the menu:Simulate[]
submenu, which allows you to test your MIDI mappings and custom
expressions as described in the <<cue-simulate,next section>>.
...
As a shortcut to simulating the most common pair of cue events
(Started On-Beat and Ended), you can hold down the kbd:[Option] (or
kbd:[Alt]) key while clicking and releasing the mouse over the cue
rectangle in the track waveform at the top of the window.

You also can use the kbd:[Option]/kbd:[Alt]-click shortcut to simulate
events from a cue's editor row using the message labels.
Option/Alt-clicking and releasing on the *Message* label in the
*Entered* row simulates Entered/Exited events.
kbd:[Option]/kbd:[Alt]-clicking on the *On-Beat Message* label in the
*Started* row simulates Started On-Beat and corresponding Ended
events, and kbd:[Option]/kbd:[Alt]-clicking on the *Late Message*
label simulates Started Late and corresponding Ended events.
...
having to lose your context and focus. https://linktr.ee/mddxmusic[Nicholas
