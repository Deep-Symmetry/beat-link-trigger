...
The *New Cue* button creates a new cue on the first beat of the Track, unless you have selected a beat range first as described below.
...
As mentioned above, you can use the *New Cue* button to do this, and then edit the cue to position it where you want it, but it is easier to specify where you want it on the beat grid first.
...
Regardless of how you do it, once you have the right beats selected, clicking the *New Cue* button will create a new cue covering the chosen beats:
...
+
If you choose *Custom* and have not yet written a Started On-Beat expression, the expression editor will be opened to let you do that.
You can also open that editor using the <<cue-context-menu,cue context menu>>.
