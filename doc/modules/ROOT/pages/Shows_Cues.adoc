...
options, and clicking on a cue with the Option or Alt key held down is
a quick way to <<cue-simulate,simulate>> its Started On-Beat and Ended
events.
...
(Started On-Beat and Ended), you can hold down the Option (or Alt) key
while clicking and releasing the mouse over the cue rectangle in the
track waveform at the top of the window.
