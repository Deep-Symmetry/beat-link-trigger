...
If you would like to test this, and don’t have any existing triggers you are concerned about losing, you can download and open the xref:attachment$/TouchOscTrackInfo.blt[configuration file] (if you do have any trigger configuration you have been experimenting with be sure to <<Debugging.adoc#saving-and-loading,save that>> first).
