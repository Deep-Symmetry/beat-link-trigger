...
https://deep-symmetry.zulipchat.com[community chat room], from a user
who wanted to set up a turn-key lighting system that automatically
started Beat Link Trigger and Carabiner. If you are in a situation like
that, you can set up a Came Online Expression to automatically open the
Carabiner window and connect to it:
