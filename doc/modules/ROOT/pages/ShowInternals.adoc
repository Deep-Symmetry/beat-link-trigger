...
quite useful. It is passed to all cue expressions as the value `cue`.
...
cue's <<Shows#entered-message,Entered Message Menu>>,
<<Shows#entered-note-spinner,Entered Note/Controller Spinner>>,
<<Shows#entered-channel-spinner,Entered Channel Spinner>>,
<<Shows#started-on-beat-menu,Started On-Beat Message Menu>>,
<<Shows#started-on-beat-note-spinner,Started On-Beat Note/Controller
Spinner>>, <<Shows#started-on-beat-channel-spinner,Started On-Beat
Channel Spinner>>, <<Shows#started-late-menu,Started Late Message
Menu>>, <<Shows#started-late-note-spinner,Started Late Note/Controller
Spinner>>, and <<Shows#started-late-channel-spinner,Started Late
...
`:hue`:: An floating point value that specifies the angle around the
color wheel that is used when drawing this cue.
...
playing it, and so on, or looked up in a track's <<#cues-map,`:cues`
map>>.
