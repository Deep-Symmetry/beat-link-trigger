...
The phrase trigger contents map, found within the show `:contents` map
contains information that can be directly saved into the show file to
represent the phrase trigger configuration the user has chosen. Some
