...
will be a green dot showing in the <<Shows.adoc#loaded-status,**Loaded
...
track's <<Shows.adoc#enabled-menu,Enabled Menu>>.
...
cue's <<Shows.adoc#entered-message,Entered Message Menu>>,
<<Shows.adoc#entered-note-spinner,Entered Note/Controller Spinner>>,
<<Shows.adoc#entered-channel-spinner,Entered Channel Spinner>>,
<<Shows.adoc#started-on-beat-menu,Started On-Beat Message Menu>>,
<<Shows.adoc#started-on-beat-note-spinner,Started On-Beat Note/Controller
Spinner>>, <<Shows.adoc#started-on-beat-channel-spinner,Started On-Beat
Channel Spinner>>, <<Shows.adoc#started-late-menu,Started Late Message
Menu>>, <<Shows.adoc#started-late-note-spinner,Started Late Note/Controller
Spinner>>, and <<Shows.adoc#started-late-channel-spinner,Started Late
