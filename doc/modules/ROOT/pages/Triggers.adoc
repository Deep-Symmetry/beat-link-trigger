...
The menu:Simulate[] submenu allows you to test your MIDI mappings and
custom expressions as described in the <<trigger-simulate,next
section>>.
...
image:TriggerSimulate.png[Trigger Simulate Menu,471,180]
