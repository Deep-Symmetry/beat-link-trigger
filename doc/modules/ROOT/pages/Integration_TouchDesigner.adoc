...
Later on, there was another discussion on the Zulip channel, in which Victor was looking for information that isn’t available directly from the phrase itself, such as “what percentage of the current phrase has been played through?” and “what is the type of the next phrase that will play?”
By poking around in the xref:ShowInternals.adoc[], he was able to come up with a https://deep-symmetry.zulipchat.com/#narrow/channel/275322-beat-link-trigger/topic/Looking.20for.20help.20sending.20phrase.20types.20over.20OSC/near/511053005[sophisticated expression] that answered those questions and more.