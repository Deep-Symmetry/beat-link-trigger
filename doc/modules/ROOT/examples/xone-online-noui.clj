  ...
  (try
    ...
    (catch Throwable t
      ...
      (seesaw/invoke-later  ;; <2>
        (seesaw/alert
          (:frame show)
          (str "<html>The XoneOnAir show was unable to open a MIDI port matching \""
               mixer-device-name
               ...
               "edit the definition of <code>mixer-device-name</code> in the Came Online "
               "Expression.<br><br>Take Beat Link Trigger offline and back online to try "
               "again.")
