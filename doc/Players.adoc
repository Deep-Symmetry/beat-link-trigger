...
not work well in the preview releases of 0.5.0 until a new mechanism
for picking tracks can be built. The current implementation relies on
menu requests to the players, which will likely fail unless you are
