...
metadata for, that option can save you a lot of time.
...
approach when you haver prearranged with your DJ to be certain that
...
image:assets/AutoAttach.png[Auto-Attach option, 324]
