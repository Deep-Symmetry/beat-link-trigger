...
a trigger to synchronize a chase on a
...
corresponding link:assets/grandMA2.blt[configuration file] and loading
that within Beat Link Trigger.
...
`gm-port`, `gm-user`, `gm-password`, and `gm-bpm-master` to match your
