...
image:assets/LiveExternalControl.png[ShowXpress Live Preferences, 739]
...
With these in place you can set up triggers which are enabled as
appropriate by tracks loaded and beat numbers reached (examples
below). If you want to control the Live BPM, it is probably easiest to
...
of beats within that track, as shown in the other examples above. This
