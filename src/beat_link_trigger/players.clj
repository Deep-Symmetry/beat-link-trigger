...
(defn- create-player-cell
  ...
  (let [art            (seesaw/canvas :size [80 :by 80] :opaque? false :paint (partial paint-art n))
        ...
        title-label    (seesaw/label :text "[track metadata not available]"
                                     :font (util/get-display-font "serif" Font/ITALIC 14) :foreground :yellow)
        artist-label   (seesaw/label :text "" :font (util/get-display-font "serif" Font/BOLD 12) :foreground :green)
